  ...
  return (
    <div className="main-banner">
            ...
            <div className="row h-100 justify-content-center align-items-center">
              <div className="col-lg-5">
                <div className="hero-content">
                  ...
                  <p>
                    My purpose is to help you build your online Business
                    presence! Furthermore, have a website or an application no
                    matter what type of website if it’s for a small business,
                    service provider, individual, organization, or a company.
                    Today people are always searching for businesses, companies,
                    or services on the internet, why don’t you be one of their
                    options?
                  </p>
      ...
      <div className="shape5">
        <img
          src={require("../../assets/images/outlook-icon-png-2175.png")}
          alt="shape"
        />
      </div>
